...
KEY_ITEM_DATA: list[KeyItemEntry] = [
    {'item_name': 'Key to Sult Ruins', 'value': 1, 'primary_map_id': 9216, 'primary_map_hex': '2400', 'unlocks_maps': [9216, 9220, 9222, 10248, 10252, 10260, 13320, 13324, 13328, 13332, 13340, 13344, 13348, 15445, 16396], 'unlocks_map_hexes': ['2400', '2404', '2406', '2808', '280C', '2814', '3408', '340C', '3410', '3414', '341C', '3420', '3424', '3C55', '400C']},
    ...
    {'item_name': 'Key to East Misty', 'value': 4, 'primary_map_id': 18440, 'primary_map_hex': '4808', 'unlocks_maps': [18440, 18444, 18448, 24580, 24584, 24588, 24596, 24600, 24592, 24604, 24608, 25600, 25604, 25608, 25616], 'unlocks_map_hexes': ['4808', '480C', '4810', '6004', '6008', '600C', '6014', '6018', '6010', '601C', '6020', '6400', '6404', '6408', '6410']},
    ...
    {'item_name': 'Key to Gumbo', 'value': 8, 'primary_map_id': 29696, 'primary_map_hex': '7400', 'unlocks_maps': [29696, 30720, 30724, 30728, 30732, 31748, 31752, 31756, 31760, 31768, 31812], 'unlocks_map_hexes': ['7400', '7800', '7804', '7808', '780C', '7C04', '7C08', '7C0C', '7C10', '7C18', '7C44']},
    ...
    {'item_name': 'Key to Zil Padon', 'value': 14, 'primary_map_id': 39941, 'primary_map_hex': '9C05', 'unlocks_maps': [39941, 39942, 39944, 39948, 46080, 46084, 46088, 46092, 46096, 46104, 46108, 46112, 46116, 46120, 46124, 51200, 51204], 'unlocks_map_hexes': ['9C05', '9C06', '9C08', '9C0C', 'B400', 'B404', 'B408', 'B40C', 'B410', 'B418', 'B41C', 'B420', 'B424', 'B428', 'B42C', 'C800', 'C804']},
...
STORY_CHECK_DATA: list[StoryCheckEntry] = [
    ...
    {'event_id': 75, 'event_hex': '0x004B', 'ap_name': '(Ghost Ship) Completed', 'map_id': 13348, 'map_hex': '3424', 'vanilla_gold': 60, 'is_finish': False, 'key_name': None, 'blocks': [13320, 13324, 13328, 13332, 13340, 13344, 13348]},
    ...
    {'event_id': 164, 'event_hex': '0x00A4', 'ap_name': '(End of the World) To the top!', 'map_id': 24608, 'map_hex': '6020', 'vanilla_gold': None, 'is_finish': False, 'key_name': None, 'blocks': [18436, 18440, 18444, 18448, 22528, 22536, 24580, 24584, 24588, 24596, 24600, 24592, 24604, 24608]},
    ...
    {'event_id': 209, 'event_hex': '0x00D1', 'ap_name': '(Volcano) Escape', 'map_id': 30728, 'map_hex': '7808', 'vanilla_gold': 390, 'is_finish': False, 'key_name': None, 'blocks': [30720, 30724, 30728, 30732]},
    ...
    {'event_id': 428, 'event_hex': '0x01AC', 'ap_name': 'Baal - Defeated', 'map_id': 53260, 'map_hex': 'D00C', 'vanilla_gold': 6000, 'is_finish': False, 'key_name': None, 'blocks': [37888, 38400, 38404, 39936, 39940, 39941, 39942, 39944, 39948, 41988, 41996, 42000, 42004, 42008, 42012, 42016, 44036, 44040, 44044, 44048, 44052, 44056, 46080, 46084, 46088, 46092, 46096, 46104, 46108, 46112, 46116, 46120, 46124, 48128, 48132, 49152, 51200, 51204, 53248, 53256, 53260]},
